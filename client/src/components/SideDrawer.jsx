...
import ProfileModel from "./chats/ProfileModel";
...
import { IoSearch, IoNotificationsSharp, IoCaretDown, IoPeopleSharp, IoPeopleCircleSharp, IoSettingsSharp} from "react-icons/io5";
        ...
        <div style={{ display: "flex" }}>
          <Menu>
            ...
            onClick={() => navigate('/settings/users')}> 
              <IoSettingsSharp color="rgba(255, 255, 255, 0.685)" />  
            </MenuButton> 
          </Menu>
          <Menu>
            <MenuButton p={2} fontSize="2xl" textAlign="center"
            onClick={() => navigate('/chats')}>
              <IoPeopleCircleSharp color="rgba(255, 255, 255, 0.685)" />  
            </MenuButton>            
          </Menu>
          <Menu>
            <MenuButton p={2} fontSize="2xl" textAlign="center">
